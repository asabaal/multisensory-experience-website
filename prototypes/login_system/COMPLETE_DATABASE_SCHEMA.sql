-- =====================================================
-- ASABAAL VENTURES - COMPLETE DATABASE SCHEMA
-- Combines existing contact system with new job processing
-- =====================================================

-- =====================================================
-- EXISTING CONTACT SYSTEM (preserve current functionality)
-- =====================================================
...
-- Keep existing contact system policies
...
-- 1. job_files - for input/output files
-- 2. user_uploads - for general user uploads
-- 3. temp_files - for temporary processing files
...
-- 1. Backward compatibility with existing contact system
-- 2. Complete user management with quotas
-- 3. Robust job queue with atomic operations
-- 4. File management with audit trails
-- 5. Security through RLS policies
-- 6. Performance through proper indexing
-- 7. Monitoring through views and functions